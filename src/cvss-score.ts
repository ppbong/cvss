 ...
 */
export function parseVectorString(vectorString: string): CvssQualitativeMetricScore {
  const metricScore: CvssQualitativeMetricScore = {
    version: "",
    vectorString: "",
    baseScore: 0,
    baseSeverity: "",
 ...
 * @returns 指标对象
 */
export function findCvssMetric(version: string, metricCode: string): CvssMetric {
  switch (version) {
 ...
 * @returns 指标评分对象
 */
export function resolveQualitativeMetricNameAndValue(metricScore: CvssQualitativeMetricScore): CvssQualitativeMetricScore {
 ...
 * @returns 指标评分对象
 */
export function calculateBaseScore(metricScore: CvssQualitativeMetricScore): CvssQualitativeMetricScore {
  // 解析指标值
 ...
 * @returns 指标评分对象
 */
export function calculateTemporalScore(metricScore: CvssQualitativeMetricScore): CvssQualitativeMetricScore {
 ...
 * @returns 指标评分对象
 */
export function calculateEnvironmentalScore(metricScore: CvssQualitativeMetricScore): CvssQualitativeMetricScore {
  if (metricScore.baseScore === 0.0) {
 ...
 * @returns 评分结果
 */
export function calculateCvssScore(vectorString: string): CvssQualitativeMetricScore {
  // 解析向量字符串
