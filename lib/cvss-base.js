 ...
 */
export const CvssV30BaseMetricMap = {
    attackVector: {
        name: "Attack Vector",
        code: "AV",
        label: "攻击向量",
    ...
    privilegesRequired: {
        ...
        values: [
            ...
            },
            {
                ...
                code: "L",
                label: "低",
                value: (isScopeOrModifiedScopeChanged) => isScopeOrModifiedScopeChanged ? 0.68 : 0.62,
            },
            {
                name: "High",
                code: "H",
                label: "高",
                value: (isScopeOrModifiedScopeChanged) => isScopeOrModifiedScopeChanged ? 0.5 : 0.27,
            },
        ],
    },
    userInteraction: {
 ...
 */
export const CvssV30TemporalMetricMap = {
    exploitCodeMaturity: {
 ...
 */
export const CvssV30EnvironmentalMetricMap = {
 ...
 */
export const CvssV31BaseMetricMap = {
 ...
 * @property {CvssMetric} reportConfidence - 报告置信度
 */
export const CvssV31TemporalMetricMap = {
 ...
 * @property {CvssMetric} modifiedAvailabilityImpact - 修改后的可用性影响
 */
export const CvssV31EnvironmentalMetricMap = {
 ...
 * @description 定性严重性等级
 */
export const CvssQualitativeSeverityRatingList = [
    {
        name: "None",
        label: "无",
        scoreScope: "0.0",
 ...
 */
export const CvssV30MetricCodeMap = {
 ...
 */
export const CvssV31MetricCodeMap = {
